...
class IError extends Error {
  /**
   * @param {itavy/Error.IErrorLiteral} options error info
   */
  constructor(options) {
    if (typeof options === 'string') {
       ...
       * @desc Error message
       * @type {String}
       * @member itavy/Error.IError#message
       */
     ...
     * @type {String}
     * @default 'ERROR'
     * @member itavy/Error.IError#name
     */
     ...
     * @type {String}
     * @default 'ERROR'
     * @member itavy/Error.IError#severity
     */
     ...
     * @type {String}
     * @default null
     * @member itavy/Error.IError#source
     */
     ...
     * @type {String}
     * @default null
     * @member itavy/Error.IError#code
     */
    ...
    if (common.has(options, 'extra') && common.has(options.extra, 'iError')) {
       ...
       * @type {*}
       * @default null
       * @member itavy/Error.IError#extra
       */
     ...
     * @default null
     * @readonly
     * @member itavy/Error.IError#origStack
     */
    ...
    /**
     * @desc Error cause
     * @type {itavy/Error.IError}
     * @default null
     * @readonly
     * @member itavy/Error.IError#cause
     */
   ...
   * @returns {itavy/Error.IErrorLiteral} IError literal representation
   * @public
   */
  toJSON() {
   ...
   * @param {String} name name of the error to look after
   * @returns {itavy/Error.IError|null} IError found or null otherwise
   * @public
   */
   ...
   * @returns {itavy/Error.IError|null} coresponding cause or null if not found
   * @private
   */
